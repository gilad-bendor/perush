...
כמו כל ספר הסטוריה טוב, גם הסיפורים המתורגמים מתארים ועוקבים אחר התפתחות ההסטורית.  
...
רצף קצרצר זה משמש כמבוא, כסקירה של מה זה תרבות ואיך היא מתפתחת.
סיפור הבריאה עוזר להבין את מושגי היסוד של המילון: אור, ארץ, צמחים, חיות ואדם.
...
- נח והמבול
- מגדל בבל
הפירוש ״מתרגם״ את הרצף הזה לסיפור של התפתחות התרבות האנושית הכללית - מהרמה הבסיסית ביותר, דרך סיפורי התפתחות **ארכיטיפיים**, עד לרמה התפתחותית גבוהה, ללא קשר ליהדות.  
