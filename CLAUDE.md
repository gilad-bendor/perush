...
כמו כל ספר הסטוריה טוב, גם הסיפורים המתורגמים מתארים ועוקבים אחר התפתחיות ההסטוריות.  
בכל ספר הסטוריה טוב, כל פרק וכל מקטע ממוקדים באספקטי עומק מסויימים. המשמעות היא שבספר היסטוריה יש פרקים עם חפיפה, ויש פרקים שמתארים תקופות חופפות - אבל באספקטים שונים.  
באותו אופן, הסיפורים המתורגמים מכילים לפעמים מידה של חפיפה - של חזרה על תקופות - אבל מתוך כוונה להאיר את התקופה מזויות נוספות.  

# תרגום לארכיטיפ \ תרגום להסטוריה ספציפית

הרכיב החשוב והמרכזי ביותר בפירוש - הוא תרגום הטקסט המקראי לסיפור תרבותי קוהרנטי ומתפתח: סיפור **ארכיטיפי** - שניתן ״להלביש״ על רצפים הסטוריים שונים בזמן ובמקום.
...
הסתבר לי שכאשר מלבישים את הסיפור על הסטוריה ספציפית ומוכרת - אז המטען הרגשי, המשמעות הרגשית של ההסטוריה - מאירה את התרגום באור עשיר בהרבה.
בנוסף, משום מה ובמפתיע, דווקא כשמלבישים את הסיפור על הסטוריה ספציפית - מילות מפתח בטקסט - שנדמים כקישוטים חסרי משמעות - הופכים להיות צירים משמעותיים בהבנה: פתאום הסיפור ההיסטורי הופך עמוק יותר, מורכב יותר, ומספק חכמת חיים ותובנות חדשות.

חשוב לי לנסות ולשמור על הפרדה בין הרכיבים: המטודולוגיה המועדפת היא לתרגם לארכיטיפ תוך היצמדות מקסימלית לטקסט המקראי, ורק אחר כך - כתוספת לא מחייבת - להלביש על הסטוריה ספציפית.
...
אני מלביש את הסיפורים המתורגמים על ההסטוריה - עם הטייה ארופוצנטרית מובהקת: בעתיד אנסה להלביש על תרבויות מרכזיות נוספות.
...
4. לקשור סיפורים מתורגמים לתקופות ותהליכים ספציפיים בהסטוריה.
